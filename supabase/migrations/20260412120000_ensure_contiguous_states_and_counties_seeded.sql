/*
  # Ensure 48 Contiguous States + Counties Are Available and Active

  Purpose:
  - Keep existing loading/query/matching logic untouched.
  - Ensure dropdown source data is complete for all 48 contiguous US states.
  - Re-apply county seed batches idempotently (ON CONFLICT DO NOTHING in source files).
*/
