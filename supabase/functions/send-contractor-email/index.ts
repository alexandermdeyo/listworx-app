      ...
      case 'application_approved':
        ...
        html = layout(
          ...
          ${successCard(`
            ...
            ${cta('Sign In &amp; Choose Your Plan &rarr;', `${BASE_URL}/contractor-portal?mode=login&email=${encodeURIComponent(to)}&redirect=${encodeURIComponent('/billing')}`)}
            ${linkFallback(`${BASE_URL}/contractor-portal?mode=login&email=${encodeURIComponent(to)}&redirect=${encodeURIComponent('/billing')}`)}
          `)}
