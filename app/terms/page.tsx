  ...
  return (
    <div className="min-h-screen bg-white text-mkt-ink mkt-scope">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <Reveal as="div">
          <h1 className="text-4xl md:text-5xl font-bold text-mkt-ink mb-4">
            Terms of Service
          </h1>
          <p className="text-sm text-mkt-ink/60 mb-8">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          <section>
            <p className="text-mkt-ink/70 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">1. Eligibility</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">2. The Service</h2>

            <h3 className="text-xl font-semibold text-mkt-ink mb-3 mt-6">For Realtors/Homeowners (Requesters)</h3>
            <p className="text-mkt-ink/70 mb-4">
            ...
            <h3 className="text-xl font-semibold text-mkt-ink mb-3 mt-6">For Contractors (Partners)</h3>
            <p className="text-mkt-ink/70 mb-4">
            ...
            <h3 className="text-xl font-semibold text-mkt-ink mb-3 mt-6">IronClad Standards</h3>
            <p className="text-mkt-ink/70">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">3. Subscriptions & Payments</h2>
            <ul className="list-disc list-inside text-mkt-ink/70 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">4. User Content & Responsibilities</h2>
            <ul className="list-disc list-inside text-mkt-ink/70 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">5. No Warranties / Limitation of Liability</h2>
            <ul className="list-disc list-inside text-mkt-ink/70 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">6. Indemnification</h2>
            <p className="text-mkt-ink/70">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">7. Termination</h2>
            <p className="text-mkt-ink/70">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">8. Governing Law / Disputes</h2>
            <p className="text-mkt-ink/70">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">9. Changes to Terms</h2>
            <p className="text-mkt-ink/70">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">10. Contact</h2>
            <p className="text-mkt-ink/70 mb-4">
              Questions about these Terms? Contact us:
            </p>
            <div className="bg-zinc-50 p-6 rounded-lg border border-zinc-200">
              <p className="text-mkt-ink font-semibold mb-2">ListWorx LLC</p>
              <p className="text-mkt-ink/70">2147 Springdale Ln F104</p>
              <p className="text-mkt-ink/70 mb-3">Gallatin, TN 37066</p>
              <p className="text-mkt-ink/70">
                Email:{' '}
                <a href="mailto:adeyo@listworx.co" className="text-lw-rust hover:text-lw-rust-hover hover:underline">
                  adeyo@listworx.co
                </a>
              </p>
              <p className="text-mkt-ink/70">
                Phone:{' '}
                <a href="tel:615-362-4996" className="text-lw-rust hover:text-lw-rust-hover hover:underline">
                  615-362-4996
                </a>
              </p>
            </div>
