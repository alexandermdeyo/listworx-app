    ...
    <div className="min-h-screen bg-white text-mkt-ink mkt-scope">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">1. Information We Collect</h2>
            <p className="text-mkt-ink/70 mb-4">
              We collect:
            </p>
            <ul className="list-disc list-inside text-mkt-ink/70 space-y-2 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">2. How We Use Your Information</h2>
            ...
            <p className="text-mkt-ink/70 mt-4">
              <strong>We do not sell personal information.</strong>
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">3. Sharing Your Information</h2>
            <ul className="list-disc list-inside text-mkt-ink/70 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">4. Data Security</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">5. Your Rights & Choices</h2>
            <ul className="list-disc list-inside text-mkt-ink/70 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">6. Children's Privacy</h2>
            <p className="text-mkt-ink/70">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">7. Changes to This Policy</h2>
            <p className="text-mkt-ink/70">
          ...
          <section>
            <h2 className="text-2xl font-bold text-mkt-ink mb-4">8. Contact Us</h2>
            <p className="text-mkt-ink/70 mb-4">
